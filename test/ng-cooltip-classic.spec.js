...
describe('ng-cooltip classic directive spec', function() {
  ...
  function getCompiledElement() {
    element = angular.element('<cooltip cooltip-type="classic" cooltip-item="\'Lorem\'" cooltip-effect="effect" cooltip-content="content"></cooltip>');
